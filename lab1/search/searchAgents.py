...
def cornersHeuristic(state: Any, problem: CornersProblem):
    ...
    while cornersLeft:
        ...
        for corner in cornersLeft:
            ...
            # distance.append((util.manhattanDistance(currentPosition,corner),corner))
            # Heuristic2: euclideanDistance
            distance.append((euclideanDistance(currentPosition,corner),corner))
        minDistance,nearestCorner = min(distance)
        result+=minDistance
